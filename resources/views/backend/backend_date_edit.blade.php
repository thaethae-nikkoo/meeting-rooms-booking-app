...
@section('front_body')
    ...
    <div class="container my-5">
        ...
        <div class="">
            ...
            <form action="{{ url('/adm-start-time-edit') }}" id="msform" class="form mt-5" method="get">
                @csrf
                        ...
                        <section class="plan cf mb-3">
                            ...
                            <div class="srow">
                                <div class="col-lg-11 col-md-4 col-sm-12">
                                    <input class="input" type="radio" name="room_id" id="vip" value="1"
                                        {{ $booking->room_id == '1' ? 'checked' : '' }} />
                        ...
                        <div class="card py-5 px-4 shadow-lg">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="col-12">
                                    ...
                                    <div class="mb-2">
                                        <label for="email" class="form-label">Email <em
                                                style="color:red">*</em></label>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" id="contact_number"
                                            name="contact_number" value="{{ $booking->phone }}" placeholder="0912345678"
