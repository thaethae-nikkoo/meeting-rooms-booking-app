...
<div class="container">
    <div class=" col-xl-12 col-12 mb-xl-0 mb-5">
        <div class="card pt-4 pb-0 mt-3 mb-3">
            ...
            <form action="{{ route('schedule.update', $schedule_id) }}" id="msform" method="post" class="form cf">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-xl-7 mb-5 col-12">
                        <div class="card py-5 px-4 shadow-lg">
                            ...
                            <input type="hidden" class="form-control" name="id" value="{{ $schedule_id }}" id="id"
                                placeholder="" />
                            ...
                            <section class="plan cf">
                                ...
                                <div class="srow">
                                    ...
                                    @for ($i = 0; $i < sizeof($durations); $i++) <div
                                        class="col-6 col-lg-3 col-md-4 col-xs-6">
                                        <input type="radio" name="duration" id="{{ $durations[$i] }}" class="input"
                                            value="{{ $durations[$i] }}" {{ $old_duration==$durations[$i] ? 'checked'
                                            : '' }} />
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="col-12">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea name="link" class="form-control" rows="5">{{ $link }}</textarea>
                                </div>
