    ...
    <div class=" col-xl-12 col-12 mb-xl-0 mb-5">
        <div class="card pt-4 pb-0 mt-3 mb-3">
            ...
            <div class="card py-5 px-4 shadow-lg">
                ...
                <form action="{{ url('/create-edit') }}" method="get" class="form cf">
                    @csrf
                    ...
                    <input type="hidden" class="form-control" value="{{ $link }}" name="link" id="link"
                        placeholder="" />
                    <input type="hidden" class="form-control" value="{{ $notes }}" name="notes" id="notes"
                        placeholder="" />
